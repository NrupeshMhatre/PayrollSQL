...
values ('Rupa', 'F','9843256578','J&M','2021-01-10');
insert into employee(name, gender, phone_number, address,startDate)
values ('Suman', 'F','7656565645','Mumbai','2021-10-01');
insert into employee(name, gender, phone_number, address,startDate)
values ('Rajesh', 'M','8675675656','AP','2021-01-04');
insert into employee(name, gender, phone_number, address,startDate)
values ('Suresh', 'M','9745643534','TN','2021-04-10');
